...
# Funktion wird definiert, mit dem der aktuelle Messwert am Sensor ausgelesen werden
#kann
...
# In dieser Funktion werden diese Daten analysiert und die Temperatur herausgelesen
#und ausgegeben
